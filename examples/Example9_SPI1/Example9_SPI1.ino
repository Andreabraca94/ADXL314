/******************************************************************************
  ...
  Read values of x/y/z axis of the ADXL313 (via SPI1), print them to terminal.
  ...
  NOTE THESE ARE FOR SPI1 (not the standard SPI pins!!)
...
{
  Serial.begin(115200);
  Serial.println("Example 9 - Reading values from ADXL313 over SPI1");
